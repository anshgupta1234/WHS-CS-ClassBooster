...
class EditorDeleteStudentPopup extends Component {
    render() {
        const {students, selectedStudentIndex, deleteStudent, toggleDeleteStudentPopup} = this.props;
        return ( 
            <div className="dashboard-popup-background">
                <div className="dashboard-popup-delete-classroom">
                    <h1>Delete {students[selectedStudentIndex].name} from your students list?</h1>
                    <h2 className="dashboard-popup-delete-classroom-warning">This action cannot be reversed</h2>
                    <button className="dashboard-popup-delete-classroom-delete" onClick={() => deleteStudent(selectedStudentIndex)}>Delete</button>
